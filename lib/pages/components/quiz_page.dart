...
class QuizQuesPage extends StatefulWidget {
  final int quizNum;
  const QuizQuesPage({super.key, required this.quizNum});

  @override
  State<QuizQuesPage> createState() => _QuizQuesPageState();
}

class _QuizQuesPageState extends State<QuizQuesPage> {
  bool hoveredBox1 = false;
  bool hoveredBox2 = false;

  String imagePath1 = "assets/images/raster_q0_0.png"; // Path to default image 1
  String imagePath2 = "assets/images/raster_q0_1.png"; // Path to default image 2
    ...
    switch(widget.quizNum){
      case 1: return Scaffold(
        body: SizedBox(
          ...
          child: Consumer<BottomStateProvider>(
                ...
                Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        selectContainer1();
                        value.updateBottomBar(selected:true);
                      },
                      child: MouseRegion(
